					...
					uni.uploadFile({
						...
						success: function(res) {
							if (res.statusCode == 200) {
								...
								d.fileVisitUrl && (_this.imageList[index] = "https://gpnutjz.soca.ink/api/v1/file/egg/oss/system" + d.fileVisitUrl)
								_this.$set(_this.statusArr, index, d.fileVisitUrl ? "1" : "3")
								resolve(index)
							} else {
